...
This repository contains word frequency data that is based on the British National Corpus. The frequency lists have been provided as a companion to the book __Word Frequencies in Written and Spoken English: based on the British National Corpus__ by Geoffrey Leech, Paul Rayson, Andrew Wilson (2001) pp. 320, Longman, London. ISBN 0582-32007-0
